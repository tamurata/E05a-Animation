...
MOVEMENT_SPEED = 3
#the difference between main1 and 2 is the movement speed code
...
class Ball:
    ...
    def update(self):
        ...
        #this codes gives the movement with the ball with using the updates continually
...
class MyGame(arcade.Window):
    ...
    def on_key_release(self, key, modifiers):
        ...
        # with the player input with keyboard, the ball location will get updated
